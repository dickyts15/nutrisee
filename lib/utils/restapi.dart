...
class DataService {
  Future insertUser(
    ...
    try {
      final response = await http.post(Uri.parse(uri), body: {
        'token': '653086ab9b493f4b9fe2579d',
        'project': 'nutrisee',
        'collection': 'user',
        'appid': appid,
        'username': username,
  ...
  Future insertLatihan(String appid, String namalatihan, String calories,
  ...
  Future insertBreakfast(
      String appid,
      String namabreakfast,
      String quantity,
      String calories,
      String carbs,
      String fat,
